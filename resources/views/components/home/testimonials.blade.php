...
<section id="testimonials" class="pt-20 lg:pt-[120px] pb-20 lg:pb-[120px] bg-gray-100 dark:bg-slate-800">
   <div class="container">
      <div
         x-data="
         {
                        ...
                        <div class="w-full">
                           <div>
                              ...
                              <p
                                 ...
                                 "
                                 >
                                 A hanúság tematikailag 2 roromból marvaszt: egyrészt a gyadt.
                              </p>
                              <h4 class="font-semibold text-dark dark:text-white text-xl">
                                 Larry Diamond
                              </h4>
                              <p class="text-body-color dark:text-white text-base">
                        ...
                        <div class="w-full">
                           <div>
                              ...
                              <p
                                 ...
                                 "
                                 >
                                 Mollitia perspiciatis est asperiores commodi labore!
                              </p>
                              <h4 class="font-semibold text-dark dark:text-white text-xl">
                                 Larry Diamond
                              </h4>
                        ...
                        <div class="w-full">
                           <div>
                              ...
                              <p
                                 ...
                                 "
                                 >
                                 Velit est sit voluptas eum sapiente omnis!
                              </p>
                              <h4 class="font-semibold text-dark dark:text-white text-xl">
                                 Larry Diamond
                              </h4>
