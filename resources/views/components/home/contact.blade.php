...
<section id="contact" class="bg-white dark:bg-slate-700 py-20 lg:py-[120px] overflow-hidden relative z-10">
  <div class="container">
      ...
      <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
        <div class="max-w-[570px] mb-12 lg:mb-0">
          ...
          <p class="text-base text-body-color dark:text-gray-200 leading-relaxed mb-9">
            Etiam pharetra ante elit, posuere pellentesque mauris luctus sit amet.
          </p>
          <div class="flex mb-8 max-w-[370px] w-full">
            ...
            <div class="w-full">
              ...
              <p class="text-base text-body-color dark:text-gray-300">etiam_pharetra@ante.elit</p>
            </div>
          </div>
          ...
          <div class="flex mb-8 max-w-[370px] w-full">
            ...
            <div class="w-full">
              ...
              <p class="text-base text-body-color dark:text-gray-300">06 20 500 500 500</p>
            </div>
          </div>
